              ...
              <div className="flex flex-row gap-4 items-start justify-between">
                <div className="flex-1 space-y-2 text-right">
                  ...
                  <div className="space-y-2 text-xs">
                    ...
                    <div className="mt-1">
                      <div 
                        className="flex flex-col gap-0.5 rounded-lg bg-emerald-50/50 dark:bg-emerald-950/10 p-1.5 border border-emerald-100/50 dark:border-emerald-900/20 kse-smart-hint-text"
                ...
                <div className="flex flex-row gap-4 items-start justify-between">
                  <div className="flex-1 space-y-2 text-right">
                    ...
                    <div className="space-y-2 text-xs">
                      ...
                      <div className="mt-1">
                        <div 
                          className="flex flex-col gap-0.5 rounded-lg bg-violet-50/50 dark:bg-violet-950/10 p-1.5 border border-violet-100/50 dark:border-violet-900/20 kse-smart-hint-text"
                          style={{ fontSize: fontSizeConfig ? `${fontSizeConfig.smartHintFontSize}px` : undefined }}
                        >
                          <span 
