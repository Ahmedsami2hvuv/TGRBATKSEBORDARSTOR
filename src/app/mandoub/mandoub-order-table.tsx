                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center justify-between gap-1.5 sm:gap-2 min-w-0 w-full">
                      ...
                      <div className="relative flex-1 min-w-0 max-w-[68%] sm:max-w-[74%]">
                        ...
                        >
                          <span className="font-black text-xs sm:text-sm text-[#FFF8F0] truncate max-w-full text-center drop-shadow-[0_1px_2px_rgba(0,0,0,0.85)] px-1">
                            {headerTextStr}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 h-full">
                        ...
                        {!isSortingMode && isAssigned && (
                          <button
                            ...
                            className="w-11 h-11 sm:w-12 sm:h-12 rounded-full text-xs sm:text-sm font-black text-white hover:scale-105 active:scale-95 transition flex items-center justify-center bg-no-repeat bg-contain cursor-pointer shrink-0 drop-shadow-md"
                            style={{
