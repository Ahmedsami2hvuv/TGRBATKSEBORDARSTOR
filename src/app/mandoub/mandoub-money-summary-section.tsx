  ...
  return (
    ...
    >
      ...
      <div className="flex flex-nowrap gap-1.5 overflow-x-auto pb-0.5 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:gap-2 sm:overflow-visible sm:pb-0">
        ...
        <div
          className="flex min-w-[4.75rem] max-w-[25%] flex-1 shrink-0 flex-col items-center justify-center rounded-lg border border-amber-300 bg-amber-50 px-1.5 py-1.5 text-center shadow-sm sm:min-w-0 sm:max-w-none sm:px-2 sm:py-2 dark:bg-[#201906] dark:border-amber-900"
          title={
