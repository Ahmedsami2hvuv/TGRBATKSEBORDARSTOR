...
import { SalaryWithdrawalDialog } from "./salary-withdrawal-dialog";
...
export function SalaryWithdrawalButton({ auth, preparerName }: Props) {
    ...
    <>
      ...
      {open && (
        <SalaryWithdrawalDialog
          ...
          onSuccess={() => {
            // تحديث الصفحة تلقائياً لتحديث الأرصدة
