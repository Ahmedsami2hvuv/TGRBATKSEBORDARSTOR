                  ...
                  {group.items.map((o) => {
                    ...
                    return (
                      <div
                        ...
                        className={`group relative rounded-[22px] px-4.5 sm:px-6 pt-4 pb-4 sm:pt-4.5 sm:pb-4.5 transition-all active:scale-[0.99] cursor-pointer flex flex-col justify-between bg-transparent bg-no-repeat bg-[length:100%_100%] w-full ${
                      ...
                      >
                        ...
                        <div className="relative z-10 flex items-center justify-between gap-1.5 sm:gap-2 min-w-0 w-full shrink-0">
                          ...
                          <div className="relative flex-1 min-w-0 max-w-[68%] sm:max-w-[74%]">
                            <div
                              className="w-full h-11 sm:h-12 rounded-full flex items-center justify-center px-3 sm:px-6 mr-0.5 sm:mr-1 mt-0.5 bg-no-repeat bg-[length:100%_100%] select-none overflow-hidden"
                              style={{
                          ...
                          <div className="flex items-center gap-1 sm:gap-1.5 shrink-0 ml-0.5 sm:ml-1">
                            ...
                            <div className="relative shrink-0">
                              <div
                                className="min-w-[76px] sm:min-w-[92px] h-10.5 sm:h-11.5 px-2 rounded-lg flex items-center justify-center text-center font-black font-mono text-base sm:text-xl tracking-wider select-none bg-no-repeat bg-[length:100%_100%] leading-none"
                                style={{
                        ...
                        <div className="relative z-10 flex items-center justify-between gap-1 sm:gap-2 my-auto py-1 px-0.5 sm:px-1 w-full min-h-[76px] sm:min-h-[84px]">
                          {/* النص الأيمن: نوع البضاعة */}
                          <div className="flex items-center justify-start flex-1 min-w-0 max-w-[28%] sm:max-w-[30%]">
                            <div className="inline-flex items-center justify-center px-2 sm:px-2.5 py-1 rounded-full bg-[#FFF8F0]/95 dark:bg-slate-900/95 border border-[#C9A86A]/40 shadow-xs max-w-full">
                          ...
                          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center pointer-events-none">
                            ...
                            <div
                              className="w-18 h-18 sm:w-20 sm:h-20 rounded-full flex items-center justify-center relative select-none bg-no-repeat bg-contain shrink-0 pointer-events-auto shadow-sm"
                              style={{
                          ...
                          <div className="flex items-center justify-end flex-1 min-w-0 max-w-[28%] sm:max-w-[30%]">
                            <div className="inline-flex items-center justify-center px-2 sm:px-2.5 py-1 rounded-full bg-[#FFF0F0]/95 dark:bg-rose-950/50 border border-[#8B0000]/30 shadow-xs max-w-full">
                        ...
                        <div className="relative z-10 flex flex-nowrap items-center justify-between gap-1 sm:gap-2 pt-1 w-full shrink-0">
