                  ...
                  {group.items.map((o) => {
                    ...
                    return (
                      <div
                        ...
                        className={`group relative rounded-[22px] px-5 sm:px-6 pt-5 pb-7 sm:pt-6 sm:pb-8 transition-all active:scale-[0.99] cursor-pointer flex flex-col justify-between bg-transparent bg-no-repeat bg-[length:100%_100%] w-full ${
                      ...
                      >
                        ...
                        <div className="relative z-10 flex items-center justify-between gap-1 sm:gap-2 my-auto py-2 px-1 sm:px-2 w-full min-h-[82px] sm:min-h-[90px]">
                          {/* النص الأيمن: نوع البضاعة */}
                          <div className="flex items-center justify-start flex-1 min-w-0 max-w-[28%] sm:max-w-[30%]">
                            <div className="inline-flex items-center justify-center px-2.5 sm:px-3 py-1 rounded-full bg-[#FFF8F0]/95 dark:bg-slate-900/95 border border-[#C9A86A]/40 shadow-xs max-w-full">
                          ...
                          <div className="flex items-center justify-end flex-1 min-w-0 max-w-[28%] sm:max-w-[30%]">
                            <div className="inline-flex items-center justify-center px-2.5 sm:px-3 py-1 rounded-full bg-[#FFF0F0]/95 dark:bg-rose-950/50 border border-[#8B0000]/30 shadow-xs max-w-full">
                        ...
                        <div className="relative z-10 flex flex-nowrap items-center justify-between gap-1 sm:gap-2 pt-1 pb-1 w-full shrink-0">
