...
import PreparerSalaryClient from "./preparer-salary-client";
...
export default async function PreparerSalaryPage({ searchParams }: Props) {
    ...
    return (
      <div className="kse-app-inner mx-auto max-w-md px-4 py-16">
        <div className="kse-glass-dark rounded-2xl border border-rose-300 p-8 text-center bg-white dark:bg-[#09090b]">
          <p className="text-lg font-bold text-rose-700">لا يمكن فتح بوابة الراتب</p>
