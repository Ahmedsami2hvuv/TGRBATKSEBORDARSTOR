        ...
        <FadeInSection>
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="https://wa.me/9647733921468?text=مرحبا اجيتك من اعلان الوضيفه من الموقع" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-3 bg-[#25D366] text-white px-8 py-5 rounded-full font-bold text-[18px] hover:bg-[#20bd5a] transition-colors shadow-lg hover:shadow-xl hover:-translate-y-1 duration-300">
