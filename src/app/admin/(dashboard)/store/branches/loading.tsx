  ...
  return (
    <div className="p-6 space-y-12" dir="rtl">
      ...
      <div className="flex flex-col items-center justify-center py-12">
        <h2 className="text-3xl font-black text-sky-900 mb-6">جاري تحميل الفروع...</h2>
        <div className="w-full max-w-2xl px-6">
          <DeliveryLoading message="نجهز لك قائمة الفروع، لحظات..." />
        </div>
      </div>

      {/* Grid Skeleton as a subtle backdrop/hint */}
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 opacity-40 grayscale pointer-events-none">
        {[...Array(5)].map((_, i) => (
          <div key={i} className="bg-white p-4 rounded-[2.5rem] border border-slate-100 space-y-4">
             ...
             <div className="h-4 w-3/4 mx-auto bg-slate-100 animate-pulse rounded-full"></div>
