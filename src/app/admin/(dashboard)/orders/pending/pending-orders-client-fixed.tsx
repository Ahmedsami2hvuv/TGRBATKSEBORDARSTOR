          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-3">
            ...
            <div className="flex gap-2">
              ...
              {order.preparerShoppingJson && (
                <button type="button" onClick={() => window.location.href = `/admin/orders/${order.id}/edit`} className="rounded-xl bg-amber-500 px-3 py-1.5 text-xs font-bold text-white shadow-sm transition hover:bg-amber-600">
                  <span>💰</span>
