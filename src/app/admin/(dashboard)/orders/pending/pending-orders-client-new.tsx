        ...
        <div key={order.id} className={`kse-glass-dark rounded-2xl border p-4 shadow-sm ${orderStatusPendingCardBorderBg(order.status)}`}>
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-3 mb-3">
            ...
            <div className="flex gap-2">
              ...
              <Link href={`/admin/orders/${order.id}/edit`} className="inline-flex items-center rounded-lg border border-sky-300 bg-sky-50 px-2.5 py-1.5 text-xs font-bold text-sky-900 hover:bg-sky-100">تعديل بيانات الطلب</Link>
            </div>
          </div>
