    ...
    <div className="space-y-6" dir="rtl">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          {excelExportEnabled ? (
            <a
              href={`/api${SECRET_ADMIN_PATH}/store/orders-history/export?q=${encodeURIComponent(q)}&minOrders=${encodeURIComponent(String(minOrders))}`}
          ...
          <Link href={`${SECRET_ADMIN_PATH}/store`} className="rounded-xl border border-slate-200 px-4 py-2 text-sm font-black hover:bg-slate-50">
            الرجوع إلى المتجر
          </Link>
        </div>
      </div>
