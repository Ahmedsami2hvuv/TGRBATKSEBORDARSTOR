  ...
  const menus = [
    {
      ...
      href: "/abo1stor3hlaa2kbr8-47/store/categories",
      emoji: "📁",
      color: "bg-blue-500",
    },
    {
    ...
    },
    {
      ...
      href: "/abo1stor3hlaa2kbr8-47/store/slides",
      emoji: "🖼️",
      color: "bg-pink-500",
    },
    {
      ...
      href: "/abo1stor3hlaa2kbr8-47/store/products",
      emoji: "📦",
      color: "bg-violet-500",
    },
    {
      ...
      href: "/abo1stor3hlaa2kbr8-47/store/orders-history",
      emoji: "🧾",
      color: "bg-amber-500",
    },
  ];
  ...
  return (
    <div className="space-y-8" dir="rtl">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <form action="/abo1stor3hlaa2kbr8-47/store" className="relative w-full md:w-96">
          <input
            name="q"
            defaultValue={q}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-3">
              ...
              {results.categories.map((c: any) => (
                <Link key={c.id} href="/abo1stor3hlaa2kbr8-47/store/categories" className="block p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 border border-transparent hover:border-slate-100 transition font-bold text-slate-700 dark:text-slate-300">
                  📁 {c.name}
                </Link>
              ))}
            </div>
            ...
            <div className="space-y-3">
              ...
              {results.branches.map((b: any) => (
                <Link key={b.id} href={`/abo1stor3hlaa2kbr8-47/store/branches?categoryId=${b.categoryId}`} className="block p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 border border-transparent hover:border-slate-100 transition">
            ...
            <div className="space-y-3">
              ...
              {results.products.map((p: any) => (
                <Link key={p.id} href={`/abo1stor3hlaa2kbr8-47/store/products?branchId=${p.branchId}`} className="block p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 border border-transparent hover:border-slate-100 transition">
