            ...
            {rows.length === 0 ? (
              ...
              rows.map((r) => (
                <tr
                  ...
                  onClick={() => router.push(`/abo1stor3hlaa2kbr8-47/orders/${r.orderId}`)}
                  onKeyDown={(e) => {
                    if (e.key === "Enter" || e.key === " ") {
                      e.preventDefault();
                      router.push(`/abo1stor3hlaa2kbr8-47/orders/${r.orderId}`);
                    }
                  }}
                >
                  ...
                  <td className="px-1 py-2 text-center" onClick={(e) => e.stopPropagation()}>
                    <Link
                      href={`/abo1stor3hlaa2kbr8-47/orders/${r.orderId}`}
