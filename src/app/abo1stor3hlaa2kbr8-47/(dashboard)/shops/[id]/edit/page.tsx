  ...
  return (
    <div className="space-y-6">
      <p className={ad.muted}>
        <Link href="/abo1stor3hlaa2kbr8-47/shops" className={ad.link}>
          ← العودة للمحلات
        </Link>
      </p>
      <div>
      ...
      <section className={ad.section}>
        <p className={`text-sm ${ad.muted}`}>
          ...
          <Link href={`/abo1stor3hlaa2kbr8-47/shops/${shop.id}/employees`} className={ad.link}>
            موظفو المحل
          </Link>
        ...
        <div className="mt-6">
          <ShopEditForm
            ...
            defaultHideFromCreditBook={shop.hideFromCreditBook}
