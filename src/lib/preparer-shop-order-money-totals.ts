...
/**
 * ضمان بقاء الدالة متوافقة مع الاستدعاءات السابقة دون أن تقوم بإنشاء أي معاملات مالية آلياً أو وهمياً.
 * تم إلغاء الإنشاء التلقائي للمعاملات المالية نهائياً لمنع أي معاملات وهمية،
 * بحيث تصبح المعاملات المالية مسجلة فقط وحصرياً بناءً على إدخال وتسديد يدوي صريح من المستخدم أو المجهز.
 */
export async function ensureMissingPreparerMoneyEvents(_preparerId?: string, _shopId?: string) {
  // تم منع التوليد والإنشاء التلقائي للمعاملات المالية كلياً لمنع المعاملات الوهمية.
  return;
}
