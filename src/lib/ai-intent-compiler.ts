...
2. "orders_bulk_archive": أرشفة الطلبات المسلمة/المكتملة لمندوب أو عدة مندوبين (أمثلة: "كل طلبيات فارس المسلمة سويلهن أرشفة"، "أرشف طلبيات المندوب فارس وحسين المسلمة"، "طلبيات فارس المكتملة حوّلهن للأرشيف"، "أرشف المسلّم مال فارس"، "كلشي مسلّم يم فارس وحسين ذبه بالأرشيف"، "طلبيات فارس الواصلة للزبون أرشفهن"، "صفّي طلبيات فارس المسلمة وسويلهن أرشفة"، "المسلمة مال فارس وحسين أرشفهن عيني").
3. "orders_assigned_list": استعلام وعرض الطلبات المسندة للمندوبين حالياً (مثال: شنو الطلبات المسندة للمندوبين، شكو طلبات عند فارس).
4. "pending_orders_list": طلب عرض الطلبات الجديدة أو المعلقة (مثال: الطلبات الجديدة، شكو طلبات معلقة).
5. "last_order_details": طلب تفاصيل آخر أو أحدث طلب في النظام (مثال: اخر طلب، شنو اخر طلب).
6. "order_create": إنشاء أو إضافة طلب جديد (مثال: سوي لي طلب جديد، ضيف طلب، طلب من محل كذا الى كذا).
7. "order_unassign": إلغاء إسناد طلب أو إرجاعه لحالة جديد (مثال: الغي الاسناد، رجعه جديد).
8. "order_details": استعلام عن تفاصيل طلب محدد برقم (مثال: تفاصيل طلب 2067).
9. "dynamic_assign_order": إسناد طلب إلى كابتن أو مندوب (مثال: اسند طلب 2054 الى فارس، حول الطلب للمندوب boos).
10. "daily_summary_report": طلب ملخص اليوم أو الأرباح (مثال: ملخص اليوم، شكد ارباحنا اليوم).
11. "order_cancel_or_reject": رفض أو إلغاء طلب (مثال: طلب رقم 2070 سوي له رفض، ارفض طلب 2054، سوي مرفوض).
12. "focused_order_edit": تعديل سعر أو رقم هاتف أو منطقة أو نوع لطلب معين (مثال: غير السعر الى 15، عدل نوع الطلب سويه مسواق).
13. "courier_zero": تصفير حساب ومستحقات مندوب (مثال: صفر لي حساب المندوب فارس، تصفير حساب فارس).
14. "get_learned_rules_list": استعلام القواعد المبرمجة في سوبابيس (مثال: شنو القواعد المخزنة بسوبابيس).
15. "friendly_greeting": التحايا والسوالف والمحادثة اللبقة (مثال: شلونك، مرحبا، شو اخبارك).
