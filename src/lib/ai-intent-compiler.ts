...
الفئات المتاحة:
1. "pending_orders_list": طلب عرض الطلبات الجديدة أو المعلقة (مثال: الطلبات الجديدة، اريد اعرف الطلبات الجديدة، شكو طلبات معلقة).
2. "last_order_details": طلب تفاصيل آخر أو أحدث طلب في النظام (مثال: اخر طلب، شنو اخر طلب، انطيني اخر طلب دخل).
3. "order_create": إنشاء أو إضافة طلب جديد (مثال: سوي لي طلب جديد، ضيف طلب، طلب من محل كذا الى كذا).
4. "order_unassign": إلغاء إسناد طلب أو إرجاعه لحالة جديد (مثال: الغي الاسناد، رجعه لحالة جديد، سوي جديد لطلب كذا).
5. "order_details": استعلام عن تفاصيل طلب محدد برقم (مثال: تفاصيل طلب 2067، معلومات طلب رقم 2042).
6. "dynamic_assign_order": إسناد طلب إلى كابتن أو مندوب (مثال: اسند طلب 2054 الى فارس، حوله للمندوب boos).
7. "daily_summary_report": طلب ملخص اليوم أو الأرباح أو تقرير اليوم (مثال: ملخص اليوم، شكد ارباحنا اليوم).
8. "order_cancel_or_reject": رفض أو إلغاء طلب (مثال: ارفض طلب 2054، طير الطلب، سوي مرفوض).
9. "focused_order_edit": تعديل سعر أو رقم هاتف أو منطقة لطلب معين (مثال: غير السعر الى 15، عدل المنطقة لطلب 2067).
...
أجب بصيغة JSON فقط بهذا الشكل:
{
  ...
  "status": "الحالة إذا ذكرت وإلا null",
