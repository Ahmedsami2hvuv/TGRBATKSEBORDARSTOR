...
export async function loadPreparerPortalOrderTableData(args: {
  ...
  const rows: MandoubRow[] = filteredByPrepf.map((o) => {
    ...
    return {
      ...
      isPreparationOrder: Boolean(o.preparerShoppingJson) || (typeof o.orderType === "string" && o.orderType.includes("تجهيز")),
      ...
      shopDoorPhotoUrl: safeStringTrim((o as any).shopDoorPhotoUrl || o.shop?.photoUrl) || null,
      customerDoorPhotoUrl: customerDoorPhotoUrl || null,
      secondCustomerDoorPhotoUrl: secondCustomerDoorPhotoUrl || null,
      imageUrl: safeStringTrim((o as any).imageUrl) || null,
      orderImageUploadedByName: safeStringTrim((o as any).orderImageUploadedByName) || null,
      shopDoorPhotoUploadedByName: safeStringTrim((o as any).shopDoorPhotoUploadedByName) || null,
      customerDoorPhotoUploadedByName: safeStringTrim((o as any).customerDoorPhotoUploadedByName) || null,
