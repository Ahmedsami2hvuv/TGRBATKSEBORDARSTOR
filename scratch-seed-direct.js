...
const connStr = "postgresql://postgres:%40Ahmedfget43ft43fr3v43r3r32rv4@db.trfjlxxeldnegjgdqefm.supabase.co:5432/postgres?sslmode=require";
...
async function main() {
  ...
  console.log("🎉 SUCCESS! Store rebuilt perfectly with new items.");
  await client.end();
}
