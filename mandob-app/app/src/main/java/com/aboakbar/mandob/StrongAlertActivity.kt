...
class StrongAlertActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnDismissStrongAlert).setOnClickListener {
            ...
            val role = intent.getStringExtra("role") ?: "mandob"
            val prefs = getSharedPreferences("AboAkbarPrefs", Context.MODE_PRIVATE)
            val userId = prefs.getString("mandob_id", "") ?: ""
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            registerReceiver(stopReceiver, IntentFilter("com.aboakbar.mandob.ACTION_STOP_STRONG_ALERT"), Context.RECEIVER_EXPORTED)
        } else {
            registerReceiver(stopReceiver, IntentFilter("com.aboakbar.mandob.ACTION_STOP_STRONG_ALERT"))
        }
    }
