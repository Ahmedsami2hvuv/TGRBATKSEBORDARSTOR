...
const connStr = "postgresql://postgres:%40Ahmedfget43ft43fr3v43r3r32rv4@db.trfjlxxeldnegjgdqefm.supabase.co:6543/postgres?sslmode=require";

async function main() {
  console.log("Connecting via PG pooler port 6543 with user postgres...");
  ...
  console.log("✅ CONNECTED SUCCESSFULLY TO DATABASE VIA POOLER 6543!");
  ...
  console.log("🎉 SUCCESS! Store rebuilt perfectly.");
  await client.end();
}

main().catch(err => {
  console.error("PG Direct Fix Error:", err);
});
