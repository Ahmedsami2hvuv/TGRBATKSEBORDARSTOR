...
6. أضف متغيرات التشغيل (من `.env.example`):
   ...
   - `ADMIN_PASSWORD` — كلمة مرور دخول `/abo1stor3hlaa2kbr8-47/login`.
...
- تسجيل الدخول: `/abo1stor3hlaa2kbr8-47/login`
- المناطق: `/abo1stor3hlaa2kbr8-47/regions` — إضافة اسم المنطقة وسعر التوصيل، بحث، تعديل، حذف.
- المحلات: `/abo1stor3hlaa2kbr8-47/shops` — اسم المحل، المنطقة، رابط اللوكيشن؛ بحث، تعديل، حذف، ورابط **الموظفون** لكل محل.
- موظفو المحل: `/abo1stor3hlaa2kbr8-47/shops/[id]/employees` — إضافة موظف (اسم + هاتف)، بحث، تعديل، حذف، رابط **واتساب** تلقائي من الرقم.
...
# Restored base commit - 2026-06-14
